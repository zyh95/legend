...
$(document).ready(function(){
    ...
    inventoryInitAjaxUsePost(path+"FactoryProductInventory/getFactoryProductInventory","json","application/json;charset=utf-8",".factory-product-inventory-table","all","","","");

    //筛选事件
    $("#fpi-select").on('click',function(){
        var productModel=$("#fpi-product-model").val();
        var productSize=$("#fpi-product-size").val();
        var productShape=$("#fpi-product-shape").val();
        inventoryInitAjaxUsePost(path+"FactoryProductInventory/getFactoryProductInventory","json","application/json;charset=utf-8",".factory-product-inventory-table","selectPage",productModel,productSize,productShape);
    })
