...
$(document).ready(function(){
    document.getElementById("bor-start-time").valueAsDate=new Date();
    document.getElementById("bor-end-time").valueAsDate=new Date();
    var targetJson;

    //初始页面
    var mydate=new Date();
    var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
    initAjaxUseGet(path+"BlowonRecord/getBlowonRecord","json","application/json;charset=utf-8",".blowon-record-table","all",0,today);

    //筛选事件
    $("#bor-select").on('click',function(){
        var $selectStartTime=DateToUnix($("#bor-start-time").val());
        var $selectEndTime=DateToUnix($("#bor-end-time").val());
        if($selectStartTime>$selectEndTime){
            alert("请选择正确的时间");
        }else{
            initAjaxUseGet(path+"BlowonRecord/getBlowonRecord","json","application/json;charset=utf-8",".blowon-record-table","selectPage",$selectStartTime,$selectEndTime);
        }
        
    })

    //近三天
    $("#bor-threeDays").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=today-3*60*60*24*1000;
        initAjaxUseGet(path+"BlowonRecord/getBlowonRecord","json","application/json;charset=utf-8",".blowon-record-table","threeDaysPage",otherday,today);
    })

    //近一周
    $("#bor-aWeek").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=today-7*60*60*24*1000;
        initAjaxUseGet(path+"BlowonRecord/getBlowonRecord","json","application/json;charset=utf-8",".blowon-record-table","aWeekPage",otherday,today);
    })

    //近两周
    $("#bor-twoWeeks").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=today-14*60*60*24*1000;
        initAjaxUseGet(path+"BlowonRecord/getBlowonRecord","json","application/json;charset=utf-8",".blowon-record-table","twoWeeksPage",otherday,today);
    })

    //近一个月
    $("#bor-aMonth").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=DateToUnix(""+mydate.getFullYear()+"-"+mydate.getMonth()+"-"+mydate.getDate())
        initAjaxUseGet(path+"BlowonRecord/getBlowonRecord","json","application/json;charset=utf-8",".blowon-record-table","aMonthPage",otherday,today);
    })
})
...
$("#bor-record-button").on('click',function(){
    ...
    $(".blowon-record-table").css("display","block");
    $(".leftover-record-table").css("display","none");
    document.getElementById("bor-start-time").valueAsDate=new Date();
    document.getElementById("bor-end-time").valueAsDate=new Date();
    var targetJson;
...
$("#lr-record-button").on('click',function(){
    ...
    $(".leftover-record-table").css("display","block");
    document.getElementById("lr-start-time").valueAsDate=new Date();
    document.getElementById("lr-end-time").valueAsDate=new Date();
    var targetJson;

    //初始页面
    var mydate=new Date();
    var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
    initAjaxUseGet(path+"BlowonRecord/getBlankRecord","json","application/json;charset=utf-8",".leftover-record-table","all",0,today);

    //筛选事件
    $("#lr-select").on('click',function(){
        var $selectStartTime=DateToUnix($("#lr-start-time").val());
        var $selectEndTime=DateToUnix($("#lr-end-time").val());
        if($selectStartTime>$selectEndTime){
            alert("请选择正确的时间");
        }else{
            initAjaxUseGet(path+"BlowonRecord/getBlankRecord","json","application/json;charset=utf-8",".leftover-record-table","selectPage",$selectStartTime,$selectEndTime);
        }
        
    })

    //近三天
    $("#lr-threeDays").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=today-3*60*60*24*1000;
        initAjaxUseGet(path+"BlowonRecord/getBlankRecord","json","application/json;charset=utf-8",".leftover-record-table","threeDaysPage",otherday,today);
    })

    //近一周
    $("#lr-aWeek").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=today-7*60*60*24*1000;
        initAjaxUseGet(path+"BlowonRecord/getBlankRecord","json","application/json;charset=utf-8",".leftover-record-table","aWeekPage",otherday,today);
    })

    //近两周
    $("#lr-twoWeeks").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=today-14*60*60*24*1000;
        initAjaxUseGet(path+"BlowonRecord/getBlankRecord","json","application/json;charset=utf-8",".leftover-record-table","twoWeeksPage",otherday,today);
    })

    //近一个月
    $("#lr-aMonth").on('click',function(){
        var mydate=new Date();
        var today=DateToUnix(""+mydate.getFullYear()+"-"+(mydate.getMonth()+1)+"-"+mydate.getDate());
        var otherday=DateToUnix(""+mydate.getFullYear()+"-"+mydate.getMonth()+"-"+mydate.getDate())
        initAjaxUseGet(path+"BlowonRecord/getBlankRecord","json","application/json;charset=utf-8",".leftover-record-table","aMonthPage",otherday,today);
    })
})///参数为当前页表格的页id和行数
